...
[data-testid="stSidebar"] { background-color: #d9caff; color: #000; padding-top: .5rem; }
...
[data-testid="stSidebar"] label:hover { background-color: #e9e0ff !important; border-radius: 8px; transition: .3s; }
